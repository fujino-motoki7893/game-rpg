...
`companion-luna` / `companion-geist`)と一部モンスター(`enemy-skeleton` / `enemy-goblin` /
`enemy-mage`)は Universal LPC Spritesheet Character Generator の素材を合成して生成しています。
